...
export const levels: PuzzleLevel[] = [
  ...
  // Level 11 - New: Zigzag Path
  {
    id: 'level-11',
    name: 'Түвшин 11: Зигзаг зам',
    description: 'Зигзаг хэлбэртэй замыг дагах',
    difficulty: 'medium',
    grid: [
      [
        { type: 'start', x: 0, y: 0 },
  ...
  // Level 12 - New: Square Pattern
  {
    id: 'level-12',
    name: 'Түвшин 12: Дөрвөлжин хэв маяг',
    description: 'Дөрвөлжин хэв маягийг дагах',
    difficulty: 'medium',
    grid: [
      [
        { type: 'start', x: 0, y: 0 },
    ...
    minSteps: 10,
    hints: [
      'Дөрвөлжин хэв маягийг дагах',
      'Loop ашиглах',
      '4 удаа давтах',
    ],
    requiredActions: ['move', 'turnRight'],
  },
  // Level 13 - New: Long Path
  {
    id: 'level-13',
    name: 'Түвшин 13: Урт зам',
    description: 'Урт замыг loop ашиглан дагах',
    difficulty: 'easy',
    grid: [
      [
        { type: 'start', x: 0, y: 0 },
    ...
    hints: [
      'Loop ашиглана уу',
      '6 удаа урагш явна уу',
      'Loop count = 6',
    ],
    requiredActions: ['move'],
  },
  // Level 14 - New: Complex Condition
  {
    id: 'level-14',
    name: 'Түвшин 14: Нарийн нөхцөл',
    description: 'Олон нөхцөл шалгах',
    difficulty: 'hard',
    grid: [
      [
        { type: 'start', x: 0, y: 0 },
    ...
    minSteps: 12,
    hints: [
      'Олон condition node ашиглах',
      'Хана байвал эргэх',
      'Хана байхгүй бол урагш яв',
    ],
    requiredActions: ['move', 'turnRight'],
  },
  // Level 15 - New: Master Challenge
  {
    id: 'level-15',
    name: 'Түвшин 15: Мастер сорилт',
    description: 'Бүх чадварыг ашиглах',
    difficulty: 'hard',
    grid: [
      [
        { type: 'start', x: 0, y: 0 },
    ...
    minSteps: 15,
    hints: [
      'Бүх node төрлийг ашиглах',
      'Loop + Condition хослуулах',
      'Алхам тоог хэмнэх',
    ],
    requiredActions: ['move', 'turnLeft', 'turnRight'],
  },
